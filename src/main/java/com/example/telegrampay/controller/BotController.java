...
public class BotController {
    ...
    public BotController(BotService botService, CreatorLookupService creatorLookupService) {
    ...
    public RegisterBotResponse register(@Valid @RequestBody RegisterBotRequest request) {
        ...
        BotInstance bot = botService.registerBot(creator, request.getName(), request.getBotToken());
    ...
    public List<BotInstance> list() {
        Creator creator = creatorLookupService.currentCreator();
        return botService.listBots(creator.getId());
    }
}
